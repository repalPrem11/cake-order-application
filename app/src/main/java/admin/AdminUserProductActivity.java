...
public class AdminUserProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId=getIntent().getStringExtra("uid");   //for user product reference
       ...
       cartListRef= FirebaseDatabase.getInstance().getReference().child("Cart List").child("Admin View").child(userId).child("Cakes");
    }
